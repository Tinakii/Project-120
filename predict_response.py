...
print("Hiya I am Stella, How Can I help you?")

while True:

    # take input from the user
    user_input = input('Can you suggest a game for me?')

    response = bot_response(user_input)
    print("Sure thing! I suggest playing ", response)